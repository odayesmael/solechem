...
import { ChevronRight, Copy, Check, ShieldCheck, Phone, Mail, MessageCircle, Clock, Truck, Package, Info, Camera, Loader2, Plus, ArrowRight } from 'lucide-react';
...
export default function ProductDetail() {
  ...
  const scrollToSection = (id: string) => {
    ...
    if (element) {
      window.scrollTo({
        top: element.offsetTop - 120, // offset
        behavior: 'smooth'
      });
      setActiveSection(id);
    }
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-slate-950 pt-28 pb-24 lg:pb-20 transition-colors duration-300">
      ...
      <div className="max-w-[1300px] mx-auto px-4">
        ...
        <div className="flex items-center flex-wrap gap-1 sm:gap-2 text-[9px] sm:text-xs font-bold text-slate-400 mb-6 sm:mb-8 uppercase tracking-widest">
          ...
          <Link to="/products" className="hover:text-orange-600 transition-colors shrink-0">Products</Link>
              ...
              <div className="space-y-12">
                  ...
                  <div className="prose prose-slate dark:prose-invert max-w-none">
                    <p className="text-slate-600 dark:text-slate-300 leading-relaxed text-[15px]">
                      {(() => {
                        ...
                        // Build a regex that matches the product name or CAS pattern (e.g. "CAS 64-19-7")
                  ...
                  <div className="prose prose-slate dark:prose-invert max-w-none text-slate-600 dark:text-slate-300 leading-relaxed text-[15px]">
                    <p>
                      {(() => {
                        ...
                        // Bold property labels (text before colons) — split by semicolons first
                  ...
                  <div className="prose prose-slate dark:prose-invert max-w-none text-slate-600 dark:text-slate-300 leading-relaxed text-[15px]">
                    <p>
                      {(() => {
                        ...
                        // Bold: Warning/Danger, GHS codes, H-codes, P-codes, section headers
                  ...
                  <div className="prose prose-slate dark:prose-invert max-w-none text-slate-600 dark:text-slate-300 leading-relaxed text-[15px]">
                    <p>
                      {(() => {
                        ...
                        if (text === 'Information not available.') return text;
                        // Bold labels before colons, and known keywords
                        const parts = text.split(';');
                        return parts.map((part: string, i: number) => {
                          const colonIdx = part.indexOf(':');
                          if (colonIdx > 0) {
                ...
                <div id="similar-products" className="bg-white dark:bg-slate-900 p-6 sm:p-8 border border-slate-200 dark:border-slate-800 scroll-mt-36">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-2">
                    {product.similarProducts && product.similarProducts.map((similarSlug: string) => {
